...
4. **Edge Orchestration & Filtering:** A local bare-metal Node-RED flow subscribes to the local broker. It acts as an intelligent firewall, filtering out MAC addresses from foreign, ambient Bluetooth devices to keep data clean. It also reformats the messages and adds location and category information.
